...
$MecoDoubaoO2oAppKey = Get-EnvOrDefault -Name 'MECO_DOUBAO_O2O_APP_KEY' -Default ''
$MecoDoubaoO2oResourceId = Get-EnvOrDefault -Name 'MECO_DOUBAO_O2O_RESOURCE_ID' -Default 'seed-icl-2.0'
$MecoDoubaoO2oAccessKeyId = Get-EnvOrDefault -Name 'MECO_DOUBAO_O2O_ACCESS_KEY_ID' -Default ''
$MecoDoubaoO2oSecretAccessKey = Get-EnvOrDefault -Name 'MECO_DOUBAO_O2O_SECRET_ACCESS_KEY' -Default ''
...
function Configure-MecoRuntimeSettings {
  ...
  $patch = @{
    ...
    doubaoO2oAppKey = $MecoDoubaoO2oAppKey
    doubaoO2oResourceId = $MecoDoubaoO2oResourceId
    doubaoO2oAccessKeyId = $MecoDoubaoO2oAccessKeyId
    doubaoO2oSecretAccessKey = $MecoDoubaoO2oSecretAccessKey

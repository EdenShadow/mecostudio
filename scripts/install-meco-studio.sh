...
MECO_OSS_ACCESS_KEY_ID="${MECO_OSS_ACCESS_KEY_ID:-LTAI5tC7E3DrmtGsXN4dSKef}"
MECO_OSS_ACCESS_KEY_SECRET="${MECO_OSS_ACCESS_KEY_SECRET:-0Imeg0eYisOok5zZpi9rJj8Vs6yZxu}"

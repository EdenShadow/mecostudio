...
```json
{
  ...
  "data": {
    ...
    "stream": {
      "m3u8_url": "https://cos.mecoai.com/streams/room_xyz789/playlist.m3u8",
      "hls_base_url": "https://cos.mecoai.com/streams/room_xyz789/playlist.m3u8",
      "stream_status": "live"
    },
...
| S→C | `start_streaming` | 开始直播命令 |
| S→C | `stop_streaming` | 停止直播命令 |

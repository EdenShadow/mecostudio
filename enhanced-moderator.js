  ...
  class EnhancedRoundTableModerator {
    ...
    getNextProtocolHintEn() {
      return `- If a message includes {next: "Name"} and Name is not you, do NOT jump in this turn.\n- If Name is you, read the caller's full context first. You may decide whether to reply; if you reply, address that caller directly first.\n- If a message includes @Name and Name is not you, do NOT jump in this turn.\n- If you are @mentioned, read the caller's context first. You may decide whether to reply (recommended to reply); if you reply, address that caller directly first.`;
    }

    getNextProtocolHintZh() {
